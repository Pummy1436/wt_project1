            ...
            <div class="pr-12 h-full flex items-center">
                <div class="relative w-full">
                    <div class="text-gray-600 absolute ml-3 inset-0 m-auto w-4 h-4">
                        <!-- Improved alt text for search icon -->
                        <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/light_with_Grey_background-svg3.svg" alt="Search icon">
                    </div>
                ...
                <div class="w-full h-full flex items-center">
                    ...
                    ?>
                        <div class="w-full h-full flex">
                            <div x-data="{
                                ...
                                <!-- Added aria-haspopup for better accessibility -->
                                <button x-ref="button" 
                                        x-on:click="toggle()" 
                                        :aria-expanded="open" 
                                    ...
                                    <?php } else { ?>
                                        <img class="rounded-full h-10 w-10 object-cover" 
                                             src="../assets/images/user/profile/<?php echo $user_data["profile_picture"]; ?>" 
                                             alt="User profile picture" />
                                    <?php } ?>
                                    <p class="text-gray-800 text-sm ml-2 hidden sm:block"><?php echo htmlspecialchars($user_data["first_name"] . " " . $user_data["last_name"]); ?></p>
                                </button>
                                ...
                                <div x-ref="panel" 
                                     ...
                                     style="display: none;" 
                                     class="absolute top-16 z-10 bg-white divide-y divide-gray-100 rounded shadow w-44">
                    ...
                    <?php } else { ?>
                        <div class="flex items-center gap-2">
                            <a href="sign-in.php">
                                <button role="button" class="h-10 min-w-fit bg-gray-200 focus:outline-none transition duration-150 ease-in-out hover:bg-gray-300 rounded text-indigo-600 px-6 py-2 mr-4 focus:ring-2 focus:ring-offset-2 focus:ring-gray-700 text-sm">Sign In</button>
                            </a>
                            <a href="sign-up.php">
                                <button role="button" class="h-10 min-w-fit focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-indigo-700 focus:outline-none transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-8 py-2 text-sm">Sign Up</button>
                            </a>
                        </div>
                    <?php } ?>
                </div>
