            ...
            <form class="mt-8 space-y-6" method="POST" enctype="multipart/form-data">
                <div class="rounded relative mt-8 h-48 mb-12">
                    <label for="banner-picture">
                        ...
                        <?php } else { ?>
                            <img src="../assets/images/user/banner/<?php echo $user_data["banner_picture"]; ?>" alt="Banner Image" class="w-full h-full object-cover absolute shadow rounded-t" />
                        <?php } ?>
                        ...
                        <div class="flex items-center px-3 py-2 rounded absolute right-0 mr-4 mt-4 cursor-pointer">
                            ...
                            <div class="ml-2 text-gray-100">
                                <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/simple_form-svg1.svg" alt="Edit Icon">
                            </div>
                        </div>
                    </label>
                    <label for="profile-picture">
                        <div class="w-20 h-20 rounded-full bg-cover bg-center bg-no-repeat absolute bottom-0 -mb-10 ml-12 shadow flex items-center justify-center">
                            ...
                            <?php } else { ?>
                                <img src="../assets/images/user/profile/<?php echo $user_data["profile_picture"]; ?>" alt="Profile Image" class="absolute z-0 h-full w-full object-cover rounded-full shadow top-0 left-0 bottom-0 right-0" />
                            <?php } ?>
                    ...
                    <div class="max-w-md w-full space-y-8">
                        ...
                        <div class="container mx-auto w-11/12 xl:w-full">
                            <div class="w-full sm:px-0 bg-white flex justify-end">
                                ...
                                <button type="submit" class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-indigo-700 focus:outline-none transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-8 py-2 text-sm">Save</button>
                            </div>
                        </div>
                    </div>
                </div>
